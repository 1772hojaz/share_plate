        ...
        child: Center( // Center the entire body content
          child: Column(
            ...
            children: [
              ...
              const Padding(
                padding: EdgeInsets.symmetric(horizontal: 20, vertical: 10), // Padding around description
                child: Text(
              ...
              const SizedBox(height: 20), // Spacer before input fields
              // New Password Field
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20), // Horizontal padding
                child: Container(
                  decoration: BoxDecoration(
                    color: const Color(0xFFF7F8F9), // Background color of the input field
                    border: Border.all(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 10), // Padding inside the container
                    child: TextFormField(
              ...
              const SizedBox(height: 20), // Spacer before confirm password field
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 5), // Horizontal padding
                child: MaterialButton(
                  ...
                  child: const Padding(
                    padding: EdgeInsets.all(15.0), // Padding inside the button
                    child: Text(
              ...
              const SizedBox(height: 20), // Spacer before the remember password section
